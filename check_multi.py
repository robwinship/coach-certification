...
# NOTE: practiceEvaluation111 is 9U PCCP (real course for 8U/9U coaches) — do NOT add it here.
# practiceEvaluation1/11 are Wix-generated duplicate column artifacts that store "No"
# for coaches where they are inapplicable instead of "NR", causing false positives.
_NON_COURSE_FIELDS = frozenset({
    "_id", "_owner", "_createdDate", "_updatedDate",
    "title", "nccp", "position", "sort", "club", "classification",
    "practiceEvaluation1", "practiceEvaluation11",
})
